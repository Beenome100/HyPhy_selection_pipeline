...
Update `'--bind /path/to/orthogroup/sequence/files'` in the slurm script. Put the slurm script in the folder Pipemake generated (whatever was specified in --workflow-dir)
...
Submit the job from within the directory generated by Pipemake (whatever was specified for --workflow-dir).
